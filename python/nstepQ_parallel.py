...
def rollout(args):
    ...
    state_list, action_list, next_state_list, reward_list, t_list = zip(*tuple_list)
    ...
    return zip(state_list, action_list, next_state_list, rolledout_reward_list, t_list)
    ...
    with tf.Session() as sess:
        ...
        for ep in range(1, train_episodes):
            ...
            for i in range(n):
                ...
                nextstate_reward_t_list = [parent_conns[i].recv() for i in range(num_envs)]
                next_state_list, reward_list, t_list = zip(*nextstate_reward_t_list)

                env_tuples = zip(state_list, action_list, next_state_list, reward_list, t_list)
            ...
            print("n_steps_train_data shape: ", np.array(n_steps_train_data).shape)
            state_list, action_list, next_state_list, reward_list, t_list = zip(*n_steps_train_data)
