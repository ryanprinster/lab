...
#         self.env_policy = ParallelEnv(level_script, obs_types, config, num_envs)
#         self.env_supervised = ParallelEnv(level_script, obs_types, config, num_envs)
...
#         # gamma)
#         self.replay_buffer = BigReplayBuffer(self.env_supervised)
...
class GridCellAgentTrainer(object):
    ...
    def __init__(self, 
        ...
        # self.a2c_agent = A2CAgent(level_script, num_envs, n, tensorboard_path, train_iterations, 
        # gamma)
        self.replay_buffer = ReplayBuffer(size=100)
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            for i in range(self.train_iterations):
                ...
                data, actions = self.rat.generateAboutNTrajectories(self.batch_size)
